 ...
 * Classes may only have multiple Interests in the same group to aid in object creation
 */
public enum Interests { Water_Activity, Hiking_Or_Parks, Sightseeing, Music_Festival, Music_Concert, Live_Music, Restaurants,
    Pop_Up_Food, Food_Trucks, Museums, Group_Fitness, Community_Gathering, Celebrations
    /*
